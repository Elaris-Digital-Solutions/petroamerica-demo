      ...
      <div className="relative z-10 section-container w-full h-full flex flex-col justify-center">
        <div className="max-w-4xl space-y-8">
          <div className="animate-fade-in opacity-0" style={{ animationDelay: "0.2s", animationFillMode: "forwards" }}>
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-secondary/10 backdrop-blur-sm border border-secondary/20 text-secondary text-sm font-bold tracking-wider rounded-full uppercase">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4 animate-slide-up opacity-0" style={{ animationDelay: "0.8s", animationFillMode: "forwards" }}>
            <Button size="xl" className="bg-secondary hover:bg-secondary-hover text-white font-bold text-lg px-8 shadow-lg shadow-secondary/20 transition-all hover:-translate-y-1">
              Conoce nuestras estaciones
              <ChevronRight className="ml-2 h-5 w-5" />
            </Button>
            <Button variant="outline" size="xl" className="border-white/30 text-white hover:bg-white/10 hover:border-white transition-all backdrop-blur-sm text-lg px-8">
